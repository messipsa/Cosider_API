...
const employeSchema = new Schema(
  {
    ...
    contrat: {
      ...
      date_debut: {
        ...
        required: [
          true,
          "le champs date de debut de contrat ne doit pas etre vide",
        ],
      },
      date_fin: {
        type: Date,
        required: [
          true,
          "le champs date de fin de contrat ne doit pas etre vide",
        ],
      },
      classification: {
        type: String,
        required: [true, "le champs classification ne doit pas etre vide"],
      },
    },
  },
  { timestamps: true }
